...
public class GetAllBranchesQueryHandler(IReadRepositoryBase<Domain.Entities.Branch> repo)
    : IRequestHandler<GetAllBranchesQuery, Result<List<BranchListResponse>>>
{
