...
public class GetAllProductsQueryHandler(IReadRepositoryBase<Domain.Entities.Product> repo)
    : IRequestHandler<GetAllProductsQuery, Result<List<ProductListResponse>>>
{
